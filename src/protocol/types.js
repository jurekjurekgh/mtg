...
export const COMMAND_TYPES = Object.freeze(['pass_priority', 'move_object', 'draw_card', 'play_land', 'tap_for_mana', 'cast_permanent', 'cast_spell', 'declare_attackers', 'declare_blockers', 'resolve_combat', 'concede']);
