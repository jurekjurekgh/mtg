...
export const EVENT_TYPES = Object.freeze(['game_created', 'object_moved', 'card_drawn', 'player_lost', 'priority_passed', 'step_advanced', 'player_conceded', 'command_rejected']);
