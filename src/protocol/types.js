...
export const COMMAND_TYPES = Object.freeze(['pass_priority', 'move_object', 'draw_card', 'play_land', 'tap_for_mana', 'plot_card', 'cast_permanent', 'cast_spell', 'activate_ability', 'declare_attackers', 'declare_blockers', 'resolve_combat', 'resolve_scry', 'resolve_backup', 'concede']);
