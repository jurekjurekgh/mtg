...
export function execute(state, input) {
  ...
  if (state.pendingTriggerTargets.length > 0) {
    ...
    const sourceLegal = Boolean(source
      ...
      && triggerConditionHolds(state, pending.ability, source));
