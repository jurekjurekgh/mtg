export const MANA_COSTS = {
  ...
  "contested-game-ball": "{2}",
  "cherished-hatchling": "{1}{G}",
  "curate": "{1}{U}",
  "curate-stx": "{1}{U}",
  ...
  "strandwalker": "{5}",
  "divine-offering": "{1}{W}",
  "weftblade-enhancer": "{5}{W}",
  "colossodon-yearling": "{2}{G}",
  "talions-messenger": "{2}{U}",
  "fortify": "{2}{W}",
  "mysidian-elder": "{2}{R}",
  "pristine-talisman": "{3}",
