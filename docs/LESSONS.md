...
**Przypadek:** — po dołożeniu jednej karty do `decks/green.txt` (dziś nie ma takiej talii — podział kolorów ADR 0023/0024) posypało się pięć testów niezwiązanych z nowymi kartami („log nie opisuje tworzenia tokenu…
