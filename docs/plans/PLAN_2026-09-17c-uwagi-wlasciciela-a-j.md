...
- [x] **E7 — integracja**: bramki finalne (`npm test` 5719/5719,
  ...
  `random(wiedzmin-bg) vs heuristic(tarkir-wur)`, seed 2039). Znalezisko
  **DOMKNIĘTE w 2026-09-17d** (M374, commit `55e0461`): root cause to grant
  lądu (Nature's Embrace) tapowany w fazie pipów „za 1" zamiast za 2 — oferta
  obiecywała 5 many, płatność produkowała 4; plan i szczegóły:
  [`PLAN_2026-09-17d-l48-grant-w-pipach.md`](PLAN_2026-09-17d-l48-grant-w-pipach.md),
  handoff [`HANDOFF_2026-09-17d-m374-grant-w-pipach.md`](../setup/HANDOFF_2026-09-17d-m374-grant-w-pipach.md).
  Dokumentacja
