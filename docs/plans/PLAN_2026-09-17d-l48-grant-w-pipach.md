...
| F3 | pomiar quick-25 (komenda z E7) + bramki (test:all, build) | `[x]` | handoff 2026-09-17d-m374 (quick-25 5 952/5 952) |
| F4 | dokumentacja (M374, historia, handoff 2026-09-17d-m374, lekcja L149, README) + PR | `[x]` | `2cecd30` (PR #127 — nie scalony, wcielony do #126) |
...
- M374 w `docs/ENGINE_MILESTONES.md`, wpis w `docs/PROJECT_HISTORY.md`,
  `docs/setup/HANDOFF_2026-09-17d-m374-grant-w-pipach.md`, lekcja **L149** (rejestr przycięty:
...
> **Dopisek 2026-09-17d (sesja #126):** PR #127 (dokumentacja M374) nie został
> scalony — właściciel zamknął go bez scalania, a zawartość wcielono do PR #126
> (rejestr L149 + narracje, M374, historia, README, handoff). Zobacz
> `docs/setup/HANDOFF_2026-09-17d.md` (sekcja „E7 — wcielenie PR #127").
