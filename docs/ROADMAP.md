...
**Aktualizacja 2026-08-08 (M55):** **168 kart supported**, 9 talii singleton, **1121/1121 testów**, 49 modułów / 1219.6 kB, B0 (9 talii / 50 seedów / 13 500 meczów) heuristic 90.4% vs random, 61.8% vs aggro (progi 0.78/0.57 utrzymane) + M52 (Batch 22) + M53 (Batch 23: 10 realnych kart — Vandalize, Expunge, Shiv's Embrace, Deepwood Denizen, Welder Automaton, Feedback, Vow of Wildness, Greater Tanuki, Scorch Spitter, Turn the Tide) + **M54 (audyt Batch 23: 3 bugi silnika + UX .ms-group) + M55 (Batch 24: 10 kart — plot dla permanentów, speed, redirect celu, lifelink counter, linked exile, sanctuary lands)** — Etapy 0–5 zamknięte, Etap 2/3 przekroczony.
