...
**Aktualizacja 2026-08-08:** 138 kart supported, 9 talii singleton, 1039/1039 testów, 49 modułów / 1098.5 kB, B0 harness + weryfikacja MtG T1–T6 (stos, cele triggerów, regeneracja, triggery na stosie) + M50 (Saga Mesmerize jako wybór gracza + audyt limitations) + M51 (UX i18n: token count, modal labels, ikony many) — Etapy 0–5 zamknięte, Etap 2/3 przekroczony.
