...
- [x] Moduł rozwiązywania adresu obrazu: `./img/` właściciela z fallbackiem na Scryfall,
      ...
      tory podglądu `scryfall`/`FOT`/`KON` przełączane MMB nad kartą (od 2026-09-14
      środkowy przycisk; wcześniej PPM od 2026-09-11, a pierwotnie scrollem jak
      w legacy — właściciel uwolnił scroll dla przewijania strony), a numery
