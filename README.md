...
| Plik | Nazwa | Kolory | Kart łącznie | w tym basic-lądy | nielandowych |
|---|---|---|---:|---:|---:|
| `worek-basni` | Worek: Baśnie | WUBRG | 39 | 13 | 26 |
...
Etapy 1–5 zamknięte, Etap 2/3 przekroczony (499 wspieranych kart realnych + 8 tylnych stron
...
Kolejne kroki:
1. **Kolejna lista kart od właściciela** — katalog nie rośnie bez niej (ADR 0029); numer nowego batcha wynika z aktualnego stanu projektu. Arkusz właściciela jest pokryty w całości (502 wiersze = 502 karty z `artId` — domknięcie batcha 58, **M420**).
2. Każda nowa karta wchodzi 100% Oracle (ADR 0022), bez specjalnych przypadków po nazwie (ADR 0002).
