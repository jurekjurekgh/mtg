...
test('M99: skutek czaru bota (+X/+X) też trafia do modala, nie tylko do logu', () => {
  ...
  // Seed 6 po Batchu 48 D (tarkir +Stampeding Elk Herd) — hunter.
  // Seed 10 po M197/K3 (dominaria -Reassembling Skeleton, landy przeliczone)
  // — hunter (kolejne sprawdzone: 7, 8, 9). Konwencja L25.
  ...
  // Konwencja L25.
  // Seed 4 po Batchu 51 (8 kart: tarkir +Typhoid Rats +Dromoka Warrior,
  // pozostałe plany bez zmian w tej parze) — hunter (kolejne sprawdzone:
  // 6, 7, 8, 9, 11, 12). Konwencja L25.
