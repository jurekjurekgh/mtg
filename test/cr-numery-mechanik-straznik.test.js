...
const PARY = [
  ...
  { mechanika: /finality/i, zakazany: /122\.1b(?![0-9a-z])/, poprawny: '122.1h',
    wyklucz: /122\.1h|keyword|słowo kluczow/i,
    zrodlo: '122.1b to liczniki słów kluczowych; finality = 122.1h (weryfikacja u źródła 2026-09-24)' },
  { mechanika: /stun/i, zakazany: /122\.1b(?![0-9a-z])/, poprawny: '122.1d',
    wyklucz: /122\.1d|keyword|słowo kluczow/i,
    zrodlo: '122.1b to liczniki słów kluczowych; stun = 122.1d (weryfikacja u źródła 2026-09-24)' },
  { mechanika: /zakry|face.?down|morph|cloa/i, zakazany: /708\.2d/, poprawny: '708.5 (albo 701.58b dla kosztu)',
    zrodlo: '708.2d nie istnieje w CR 2026-09-25 (708.2 ma tylko 2a/2b)' },
  { mechanika: /dobrani|draw/i, zakazany: /122\.12/, poprawny: '121.1',
    zrodlo: '122.12 nie istnieje (122 = Liczniki, kończy się na 122.9); dobrań opisuje 121.x' },
