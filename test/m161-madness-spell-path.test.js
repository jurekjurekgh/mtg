...
test('S4: timing ignorowany (CR 702.35a) — cleanup i tura przeciwnika', () => {
  ...
  assert.ok(resA.ok, `sorcery za madness w cleanup legalny (CR 702.35a), a był: ${resA.events?.[0]?.reason}`);
